//A list of pokemon with name, image and type
const pokemonList = [
  {
    name: "ivysaur",
    pokemonImage:
...
//gets the container in which we want to put all the information
const getContainer = document.getElementById("pokemon-container");
...
function getQoute() {
  ...
  <div class="selected-pokemon">
    <img src="${randomPokemon.pokemonImage}" alt="${randomPokemon.name} image"/>
